    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Name')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('code', models.CharField(blank=True, help_text='Department code or abbreviation', max_length=20, verbose_name='Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Name')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('code', models.CharField(blank=True, help_text='Sub-department code or abbreviation', max_length=20, verbose_name='Code')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subdepartments', to='tickets.department', verbose_name='Department')),
                ('manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='managed_subdepartments', to=settings.AUTH_USER_MODEL, verbose_name='Sub-department Manager')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office_door_number', models.CharField(blank=True, help_text='Optional: Enter the office door number', max_length=20, null=True, verbose_name='Office Door Number')),
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tickets', to='tickets.department', verbose_name='Department')),
                ('subdepartment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tickets', to='tickets.subdepartment', verbose_name='Sub-department')),
        ...
        migrations.AddIndex(
            model_name='ticket',
            index=models.Index(fields=['department', 'subdepartment'], name='tickets_tic_departm_5a853f_idx'),
        ),
    ]
